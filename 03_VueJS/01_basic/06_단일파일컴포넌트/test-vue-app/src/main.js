...
import { createApp } from 'vue'; // vue 라이브러리에서 앱을 만들 수 있는 함수 가져오기
...
// // OPTION 1 : 전역 컴포넌트 등록
// import CheckboxItem from './Components/CheckboxItem.vue'; // CheckboxItem.vue 파일 가져오기
// // 다른 컴포넌트에서 CheckboxItem 컴포넌트를 사용할 수 있도록, 전역 컴포넌트로 등록하기
// // 다른곳에서는 checboxitem1이라는 거로 사용하겠다
// createApp(App).component('CheckboxItem1', CheckboxItem).mount('#app');

createApp(App).mount('#app');
// App.vue를 기반으로, Vue app을 만들어서,
// index.html에 있는 #app인 요소에 붙이기
